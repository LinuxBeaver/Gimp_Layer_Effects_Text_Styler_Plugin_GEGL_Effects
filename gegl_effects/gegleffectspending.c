...
enum_start (my_major_plugins_ge)
...
enum_end (GeglBlendModeTypecbsharpge)
...
property_enum (amazinglist, _("Select a Major Text Plugin"),
    mymajorpluginsge, my_major_plugins_ge,
...
property_enum (universalblendmode, _("Blend CustomBevel, SharpBevel, GMM (NA others)"),
    GeglBlendModeTypecbsharpge, gegl_blend_mode_typecbsharp_ge,
