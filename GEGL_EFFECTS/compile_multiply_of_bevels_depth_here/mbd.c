...
property_double (radius2, _("Multiplication of Bevel's Depth"), 1.0)
...
#define GEGL_OP_META
#define GEGL_OP_NAME     mbd
#define GEGL_OP_C_SOURCE mbd.c
...
static void attach (GeglOperation *operation)
{
  ...
  gegl_operation_meta_redirect (operation, "radius2", blur2, "bevel2");
...
gegl_op_class_init (GeglOpClass *klass)
{
  ...
  gegl_operation_class_set_keys (operation_class,
    "name",        "gegl:mbd",
    "title",       _("Multiply depth'"),
    "categories",  "hidden",
    "reference-hash", "45e6a238a5125700fc254001b2ac",
