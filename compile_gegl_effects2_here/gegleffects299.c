...
enum_start (gegl_blend_mode_type_effectsgzzimagecrop)
  ...
  enum_value (GEGL_BLEND_MODE_TYPE_HSVHUEIMAGE,      "HSVHue",
              N_("HSV Hue"))
enum_end (GeglBlendModeTypegzzimagecrop)
...
enum_value   (BEAVER_UI_imagepartner, "imagepartner", N_("Image file upload"))
...
property_color  (optioncolor, _("Text color change (starts out transparent)"), "Transparent")
    description (_("Default fuctions like a color overlay on transparent but you can give it any color you want  "))
  ui_meta ("visible", "guichange {strokeshadow}")
...
ui_meta ("visible", "guichange {imagepartner}")

property_enum (imageblendmode, _("Blend Mode of Image File Overlay (For layer content)"),
    GeglBlendModeTypegzzimagecrop, gegl_blend_mode_type_effectsgzzimagecrop,
...
static void attach (GeglOperation *operation)
{
  ...
  GeglProperties *o = GEGL_PROPERTIES (operation);
  GeglNode *input, *output, *image, *mbd, *mbdopacity, *mcol2, *nopig, *multiplyb, *over, *nopcolor, *grainextract, *hslcolorig, *overlayig, *softlightig, *screenig, *linearlightig, *multiplyig, *grainmerge, *grainmergeig, *addition, *subtract,  *nopb,  *stroke, *innerglow,  *ds,  *nopimage, *atopi, *saturation, *hardlightig, *burnig, *lchcolorig, *shinygm, *colordodge, *hardlight, *screen,  *microblur, *thinbold, *opacityinput, *xor, *knockoutidref, *beveloff, *extrassg, *nopextrassg, *behindextrassg, *grainmergeimage, *additionimage, *overlayimage, *multiplyimage, *screenimage, *hslcolorimage, *softlightimage, *linearlightimage, *hardlightimage, *lchcolorimage, *hsvhueimage,  *strokebehind, *nopstrokebehind, *nopdsbehind, *dsbehind, *glassovertext, *glassover, *nopglass, *repairgeglgraph, *hueig;
...
gegl_op_class_init (GeglOpClass *klass)
{
 ...
 /*btw, if GEGL Effects (or any of my plugins) ever breaks try changing the name space from gegl: or lb: to something else.*/
  gegl_operation_class_set_keys (operation_class,
    ...
    "description", _("GEGL text styling and specialty image outlining filter. June 30th 2024 2.99.19 crash free build"
                     ""),
