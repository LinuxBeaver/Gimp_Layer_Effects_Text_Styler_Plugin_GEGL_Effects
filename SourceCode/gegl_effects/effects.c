...
property_double (outline_grow_radius, _("Outlineꞌs size"), 12.0)
...
property_color  (outline_color, _("Outlineꞌs color"), "#000000")
...
property_double (inner_glow_radius, _("Inner glowꞌs blur intensity"), 4.5)
...
property_double (inner_glow_grow_radius, _("Inner glowꞌs size"), 5)
  value_range   (1, 40.0)
  ui_range      (1, 30.0)
  ui_digits     (0)
  ui_steps      (1, 5)
...
property_double (inner_glow_opacity, _("Inner glowꞌs opacity"), 1.4)
  value_range   (0.0, 2.0)
  ui_steps      (0.01, 0.10)
  ui_meta ("visible", "guichange {innerglowbevel}")
  ui_meta     ("sensitive", " enable_inner_glow")
...
property_double  (inner_glow_reach, _("Inner glowꞌs unmodified pixel fix"), 75)
  value_range (50, 85)
...
property_double (os_hue, _("Hue rotation of outlineꞌs image file overlay"),  0.0)
...
property_double (os_lightness, _("Lightness of outlineꞌs image file overlay"), 0.0)
...
property_double (shadow_blur_image, _("Blur shadow/glowꞌs image file overlay"), 0)
...
property_double (outline_extra_opacity, _("Extra outline/shadow/glowꞌs opacity"), 1.0)
  value_range   (0.0, 1.0)
  ui_steps      (0.01, 0.50)
  ui_meta ("visible", "guichange {extraosg}")
...
property_enum   (outline_extra_grow_shape, _("Extra outline/shadow/glowꞌs base shape"),
...
property_double (outline_extra_grow_radius, _("Extra outlineꞌs size (must be past default outline)"), 19.0)
  value_range   (0.0, 100.0)
  ui_range      (0.0, 100.0)
  ui_digits     (0)
  ui_steps      (1, 5)
...
property_color  (outline_extra_color, _("Extra outline/shadow/glowꞌs color"), "#00a1ff")
  description   (_("The outlineꞌs color"))
  ui_meta ("visible", "guichange {extraosg}")
  ui_meta     ("sensitive", " enable_outline_extra")
...
property_double (ose_hue, _("Hue rotation of outlineꞌs image file overlay"),  0.0)
   description  (_("Hue adjustment"))
   value_range  (-180.0, 180.0)
  ui_meta ("visible", "guichange {extraosg}")
  ui_meta     ("sensitive", " enable_outline_extra")
...
property_double (ose_lightness, _("Lightness of outlineꞌs image file overlay"), 0.0)
   description  (_("Lightness adjustment"))
   value_range  (-100.0, 100.0)
  ui_meta ("visible", "guichange {extraosg}")
  ui_meta     ("sensitive", " enable_outline_extra")
...
property_double (shine_blend_power, _("Shineꞌs dark to light intensity"), -0.600)
