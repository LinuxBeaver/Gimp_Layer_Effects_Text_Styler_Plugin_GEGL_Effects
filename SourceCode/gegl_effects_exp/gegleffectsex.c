...
property_double (bevelopacity, _("Bevel's Opacity"), 1.00)
...
/* atopg was named based on the gegl blend mode "src-atop  combined with gradient G hence the name "atopg*/
  ...
  if (o->innerglow)
  {
    if (o->gradient)
    {
      ...
      /*inner glow leg clop fix due to bevel's dst*/
...
drop shadow is applied in a gegl graph below them.*/
 ...
 /* All nodes relating to glass on text end here */
  ...
  /*Beginning of GEGL Graph's GUI asociations*/
  gegl_operation_meta_redirect (operation, "graphstring", anythinggraph, "string"); 
  /*End of GEGL Graph's GUI asociations*/
  ...
  /*Beginning of Amazing Text Styling Plugin's GUI asociations*/
  ...
  /*End of Amazing Text Styling Plugin's GUI asociations*/
