...
property_double (radius_stroke, _("Outlineꞌs Blur radius"), 0.0)
  value_range   (0.0, 2.0)
  ui_range      (0.0, 2.0)
  ui_steps      (1, 5)
  ui_gamma      (1.5)
...
property_int (grow_radius_stroke, _("Outlineꞌs Grow radius"), 12)
  value_range   (0, 100)
  ui_range      (0, 50)
  ui_steps      (1, 5)
  ui_gamma      (1.5)
...
property_double (opacity_stroke, _("Outlineꞌs Opacity"), 1.0)
  value_range   (0.0, 1.0)
  ui_steps      (0.01, 0.10)

property_color  (color_stroke, _("Outlineꞌs Color"), "white")
  description   (_("The shadowꞌs color (defaults to ꞌwhiteꞌ)"))
...
gegl_op_class_init (GeglOpClass *klass)
{
  ...
  gegl_operation_class_set_keys (operation_class,
    ...
    "description", _("First version of Beaverꞌs layerfx plugin (recreated). This is how Beaverꞌs layerfx plugin appeared on its debut date in May 11 2022."
                     ""),
    NULL);
}
