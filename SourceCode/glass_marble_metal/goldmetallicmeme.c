...
property_double (bloom, _("Bloom Glow Strength"), 22)
    description(_("Runs GEGLs glow lighting effect/orton filter ꞌBloomꞌ on the bevel. There is no orton due to this being a bevel but it will create an intense lighting. "))
...
property_int  (radius, _("Medianꞌs Radius (wideness control)"), 6)
  value_range (0, 30)
  ui_range    (0, 30)
...
property_double  (alphapercentile, _("Medianꞌs Alpha Percentile (wideness control)"), 30)
  value_range (0, 30)
...
property_double (depth, _("Depth and or detail of bevel"), 24.0)
    description (_("Embossꞌs depth setting to increase depth and detail to the bevel"))
    value_range (1, 99)
    ui_meta ("unit", "degree")
