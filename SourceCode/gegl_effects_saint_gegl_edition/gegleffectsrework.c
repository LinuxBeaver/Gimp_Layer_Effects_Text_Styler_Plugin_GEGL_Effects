 ...
 *2024 Beaver, a special build of GEGL Effects for GIMP 2.99.19 that doesnꞌt crash because it has no gegl crop
 */
...
property_double (opacitystroke, _("Outlineꞌs Opacity"), 2.0)
  value_range   (0.0, 2.0)
  ui_steps      (0.01, 0.50)
  ui_meta ("visible", "guichange {strokeshadow}")
...
property_int (grow_radiusstroke, _("Outlineꞌs Size"), 12)
  value_range   (0, 100)
  ui_range      (0, 50)
  ui_steps      (1, 5)
  ui_gamma      (1.5)
...
property_int (innerggrow_radius, _("Inner Glowꞌs Size"), 5)
  value_range   (1, 40)
  ui_range      (1, 30)
  ui_steps      (1, 5)
  ui_gamma      (1.5)
...
property_double (opacitystrokeextraoutline, _("Extra Outline/Shadow/Glowꞌs Opacity"), 2.0)
  value_range   (0.0, 2.0)
  ui_steps      (0.01, 0.50)
  ui_meta ("visible", "guichange {extraosg}")
...
property_int (grow_radiusstrokeextraoutline, _("Extra Outlineꞌs Size (must be past default outline)"), 19)
  value_range   (0, 100)
  ui_range      (0, 100)
  ui_steps      (1, 5)
  ui_gamma      (1.5)
...
property_int (osdepthextra, _("Extra Outlineꞌs Bevel Depth"), 22)
    description (_("Depth of Outline Bevel that works with some but not all blend modes"))
    value_range (1, 40)
  ui_meta ("visible", "guichange {extraosg}")
...
/* All nodes relating to outline begin here.
  ...
  zzstrokebevelis a hidden operation; recreation of gimpꞌs drop shadow filter with heavy modification so it can do things like bevel outlines, aura seeds 
...
/* All nodes relating to shadow begin here. */
  ...
  /* zzstrokebevel is a hidden operation; recreation of gimpꞌs drop shadow filter with heavy modification so it can do things like bevel outlines, aura seeds.
gegl effects use to use the default drop shadow until Beaver realized that the only way to give GEGL Effects styles seen in Adobeꞌs layer effects was to abandon gegl:dropshadow and
make a enhanced version of it. */
...
/*more nops dsts Iꞌm not lazy to organizeꞌ*/
...
/*More nops/dsts that I donꞌt give a F about organizingꞌ*/
