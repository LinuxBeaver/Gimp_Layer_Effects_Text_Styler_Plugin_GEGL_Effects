...
property_enum (blendmodebeveloutline, _("Blend Mode of Bevelꞌs emboss"),
...
gegl_op_class_init (GeglOpClass *klass)
{
  ...
  gegl_operation_class_set_keys (operation_class,
   ...
   "categories",  "hidden", 
    ...
    "description", _("This is a rough reimagination of Gimpꞌs drop shadow filter with many new things and technical options that drop shadow was not capable of doing - currently this is a hidden operation used to power Beaverꞌs personal version of GEGL Effects "
                     ""),
    NULL);
}
