...
/*Shiny Text ENUM list one of two here. This is gegl:sinusꞌs native settings. */
...
GeglOperationMetaClass *operation_meta_class = GEGL_OPERATION_META_CLASS (klass);
  ...
  gegl_operation_class_set_keys (operation_class,
    ...
    "description", _("GEGL renders a shiny effect on text. This wonꞌt work on normal images. Only Text! Users are specified to use Gimp/GEGL blend modes and opacity slider with this"),
    NULL);
}
